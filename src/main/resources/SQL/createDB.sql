...
INSERT INTO user_table SET uid='10000000000',upassword='123456', uname='系统',uavatar='/static/head-img/DiDi.jpg', collage='系统', uclass='系统', create_time=NOW(), update_time=NOW();
...
INSERT INTO user_table SET uid='12345678910',upassword='123456', uname='管理员',uavatar='/static/head-img/DiDi.jpg', collage='系统', create_time=NOW(), update_time=NOW();
...
INSERT INTO corporation_table SET cid='100000',cname='管理',create_time=NOW(), update_time=NOW();
...
CREATE TABLE corporationm_table(
	...
	cmlevel int DEFAULT 1 COMMENT '社团管理人员的身份，1为部门人员，2为社长，3为管理员',
	create_time datetime COMMENT '条目创建时间',
	update_time datetime COMMENT '条目更新时间',
...
INSERT INTO corporationm_table SET cmid='12345678910',cid='100000',cmlevel='3',create_time=NOW(), update_time=NOW();
...
CREATE TABLE activity_table(
	...
	nclick BIGINT NOT NULL COMMENT '活动点击次数'
	create_time datetime COMMENT '条目创建时间',
	update_time datetime COMMENT '条目更新时间',
	FOREIGN KEY (cid) REFERENCES corporation_table(cid),
...
CREATE TABLE news_table(
	newsid BIGINT(5) PRIMARY KEY NOT NULL auto_increment COMMENT '资讯ID,5位数字',
	newstitle LONGTEXT NOT NULL COMMENT '资讯标题',
	newscontent VARCHAR(255) NOT NULL COMMENT '资讯内容',
	newsimage VARCHAR(255) COMMENT '活动封面图片',
	suid CHAR(11) NOT NULL COMMENT '发送资讯的用户ID，长11位',
	create_time datetime COMMENT '条目创建时间',
	update_time datetime COMMENT '条目更新时间',
	FOREIGN KEY (suid) REFERENCES user_table(uid)
);

INSERT INTO news_table SET newsid=10001,newstitle='劲爆消息',newscontent='前天天气真不错',newsimage='/static/swiper-img/1.jpg',suid='12345678910',create_time=NOW(), update_time=NOW();
INSERT INTO news_table SET newsid=10002,newstitle='劲爆消息',newscontent='前天天气真不错',newsimage='/static/swiper-img/1.jpg',suid='12345678910',create_time=NOW(), update_time=NOW();
INSERT INTO news_table SET newsid=10003,newstitle='劲爆消息',newscontent='前天天气真不错',newsimage='/static/swiper-img/1.jpg',suid='12345678910',create_time=NOW(), update_time=NOW();